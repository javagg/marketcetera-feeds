 ...
 * the support for options is somewhat weak as {@link #guessExpirationType(MySQLQuantum, Option)}, {@link #guessHasDeliverable(MySQLQuantum, Option)},
 * and {@link #guessMultiplier(MySQLQuantum, Option)} all yield default values.  A more robust interpretation would add support for extra fields
 ...
 * @version $Id: BasicMySQLFeedEventTranslator.java 16154 2012-07-14 16:34:05Z colin $
 * @since 2.1.0
 */
@Immutable
public class BasicMySQLFeedEventTranslator
        extends MySQLFeedEventTranslator
{
    /* (non-Javadoc)
     * @see org.marketcetera.marketdata.mysql.MySQLFeedEventTranslator#toEvent(java.lang.Object, java.lang.String)
     */
    @Override
            ...
            throws CoreException
    {
        ...
        MySQLQuantum data = (MySQLQuantum)inData;
     ...
     *
     * @param inData a <code>MySQLQuantum</code> value
     * @throws CoreException if the required fields are not present
     */
    protected void validateMarketstat(MySQLQuantum inData)
            throws CoreException
    {
     ...
     * @throws CoreException if the required fields are not present
     */
    protected void validateDividend(MySQLQuantum inData)
            throws CoreException
    {
        validateRequiredFields(inData,
     ...
     * @throws CoreException if the required fields are not present
     */
    protected void validateBid(MySQLQuantum inData)
            throws CoreException
    {
     ...
     * @throws CoreException if the required fields are not present
     */
    protected void validateAsk(MySQLQuantum inData)
            throws CoreException
    {
        validateQuote(inData);
    }
     ...
     * @throws CoreException if the required fields are not present
     */
    protected void validateQuote(MySQLQuantum inData)
            throws CoreException
    {
        validateRequiredFields(inData,
                               requiredQuoteFields);
     ...
     * @throws CoreException if the required fields are not present
     */
    protected void validateTrade(MySQLQuantum inData)
            throws CoreException
    {
        validateRequiredFields(inData,
                               requiredTradeFields);
     ...
     * @throws CoreException if the required fields are not present
     */
    protected void validateRequiredFields(MySQLQuantum inData,
     ...
     */
    protected MarketstatEvent processMarketstat(MySQLQuantum inData)
            throws CoreException
    {
        if(inData == null) {
     ...
     */
    protected DividendEvent processDividend(MySQLQuantum inData)
            throws CoreException
    {
        if(inData == null) {
            throw new NullPointerException();
     ...
     */
    protected BidEvent processBid(MySQLQuantum inData)
            throws CoreException
    {
        if(inData == null) {
            throw new NullPointerException();
     ...
     */
    protected AskEvent processAsk(MySQLQuantum inData)
            throws CoreException
    {
        if(inData == null) {
            throw new NullPointerException();
     ...
     */
    protected TradeEvent processTrade(MySQLQuantum inData)
            throws CoreException
    {
        if(inData == null) {
            throw new NullPointerException();
     ...
     */
    protected QuoteEvent processQuote(MySQLQuantum inData,
     ...
     */
    protected EventType guessEventType(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected DividendType guessDividendType(MySQLQuantum inData)
            throws CoreException
    {
        String type = guessString(inData,
                                  5);
     ...
     */
    protected DividendStatus guessDividendStatus(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected String guessDividendRecordDate(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected String guessDividendPaymentDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           10);
     ...
     */
    protected Equity guessDividendEquity(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected DividendFrequency guessDividendFrequency(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected String guessDividendExecutionDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           8);
     ...
     */
    protected String guessDividendDeclareDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           11);
     ...
     */
    protected String guessDividendCurrency(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           4);
     ...
     */
    protected BigDecimal guessDividendAmount(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected String guessTradeDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           3);
     ...
     */
    protected boolean guessHasDeliverable(MySQLQuantum inData,
                                          Option inOption)
            throws CoreException
    {
        return true; 
     ...
     */
    protected Instrument guessUnderlyingInstrument(MySQLQuantum inData,
                                                   Option inOption)
            throws CoreException
    {
     ...
     */
    protected BigDecimal guessMultiplier(MySQLQuantum inData,
                                         Option inOption)
            throws CoreException
    {
     ...
     */
    protected ExpirationType guessExpirationType(MySQLQuantum inData,
                                                 Option inOption)
            throws CoreException
    {
     ...
     */
    protected BigDecimal guessSize(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               6);
     ...
     */
    protected String guessQuoteDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           3);
     ...
     */
    protected BigDecimal guessPrice(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               5);
     ...
     */
    protected long guessMessageId(MySQLQuantum inData)
            throws CoreException
    {
     ...
     * 
     * @param inData a <code>MySQLQuantum</code> value containing an element of data from the CSV file
     * @return an <code>Instrument</code> value
     ...
     */
    protected Instrument guessInstrument(MySQLQuantum inData)
            throws CoreException
    {
        String symbol = guessString(inData,
                                    2);
     ...
     */
    protected QuoteAction guessQuoteAction(MySQLQuantum inData)
            throws CoreException
    {
     ...
     * @return a <code>String</code> value or <code>null</code>
     */
    protected String guessExchange(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           4);
     ...
     */
    protected Date guessEventTimestamp(MySQLQuantum inData)
            throws CoreException
    {
     ...
     */
    protected String guessCloseExchange(MySQLQuantum inData)
            throws CoreException
    {
       return guessString(inData,
                          16);
     ...
     */
    protected String guessLowExchange(MySQLQuantum inData)
            throws CoreException
    {
       return guessString(inData,
                          15);
     ...
     */
    protected String guessHighExchange(MySQLQuantum inData)
            throws CoreException
    {
       return guessString(inData,
                          14);
     ...
     */
    protected String guessOpenExchange(MySQLQuantum inData)
            throws CoreException
    {
       return guessString(inData,
                          13);
     ...
     */
    protected String guessTradeLowTime(MySQLQuantum inData)
            throws CoreException
    {
       return guessString(inData,
                          12);
     ...
     */
    protected String guessTradeHighTime(MySQLQuantum inData)
            throws CoreException
    {
       return guessString(inData,
                          11); 
     ...
     */
    protected String guessPreviousCloseDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           10);
     ...
     */
    protected BigDecimal guessLowPrice(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               5);
     ...
     */
    protected BigDecimal guessHighPrice(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               4);
     ...
     */
    protected BigDecimal guessClosePrice(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               6);
     ...
     */
    protected BigDecimal guessVolume(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               8);
     ...
     * @throws CoreException if the given data cannot be interpreted as a close price
     */
    protected BigDecimal guessPreviousClosePrice(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               7);
     ...
     */
    protected BigDecimal guessOpenPrice(MySQLQuantum inData)
            throws CoreException
    {
        return guessBigDecimal(inData,
                               3);
     ...
     */
    protected String guessCloseDate(MySQLQuantum inData)
            throws CoreException
    {
        return guessString(inData,
                           9);
     ...
     * @return a <code>String</code> value or <code>null</code>
     */
    protected String guessString(MySQLQuantum inData,
                                 int inIndex)
    {
        if(inData == null) {
            return null;
     ...
     */
    protected Date guessDate(MySQLQuantum inData,
                             int inIndex)
            throws CoreException
    {
     ...
     */
    protected BigDecimal guessBigDecimal(MySQLQuantum inData,
                                         int inIndex)
            throws CoreException
    {
        String dataChunk = guessString(inData,
