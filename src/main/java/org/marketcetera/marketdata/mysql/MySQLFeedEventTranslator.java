 ...
 * a subclass of <code>MySQLFeedEventTranslator</code> that handles a single
 * line from the CSV file.  In the subclass, override {@link #toEvent(Object, String)}.
 * Provide the FQN of the subclass to the {@link MySQLFeedCredentials} object so the
 ...
 * @since 2.1.0
 * @version $Id: MySQLFeedEventTranslator.java 16154 2012-07-14 16:34:05Z colin $
 */
@ClassVersion("$Id: MySQLFeedEventTranslator.java 16154 2012-07-14 16:34:05Z colin $")
public class MySQLFeedEventTranslator
