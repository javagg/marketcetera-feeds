 ...
 * to interpret it.
 * 
 * <p>Objects of this type are passed to {@link MySQLFeedEventTranslator#toEvent(Object, String)} implementations.
 *
 * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
 * @since 2.1.0
 * @version $Id: MySQLQuantum.java 16154 2012-07-14 16:34:05Z colin $
 */
@ClassVersion("$Id: MySQLQuantum.java 16154 2012-07-14 16:34:05Z colin $")
public class MySQLQuantum
{
    /**
     * Gets a <code>MySQLQuantum</code> object with the given properties.
     *
     ...
     * @return a <code>MySQLQuantum</code> value
     */
    static MySQLQuantum getQuantum(String[] inLine,
                                 MarketDataRequest inRequest,
                                 double inReplayRate)
    {
        return new MySQLQuantum(inLine,
                              inRequest,
                              inReplayRate);
    }
    /**
