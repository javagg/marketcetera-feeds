...
/**
 * Exposes {@link MySQLFeedCredentials} attributes.
 * 
 * @author toli kuznets
 * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
 * @since 2.1.0
 * @version $Id: MySQLFeedMXBean.java 16154 2012-07-14 16:34:05Z colin $
 */
@MXBean(true)
@DisplayName("Management Interface for CSV Market Data Adapter")
@ClassVersion("$Id: MySQLFeedMXBean.java 16154 2012-07-14 16:34:05Z colin $")
public interface MySQLFeedMXBean
