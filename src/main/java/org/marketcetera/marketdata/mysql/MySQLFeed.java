 ...
 * @since 2.1.0
 * @version $Id: MySQLFeed.java 16154 2012-07-14 16:34:05Z colin $
 */
        ...
        MySQLFeed>
{
     ...
     * @return a <code>MySQLFeed</code> value
     * @throws org.marketcetera.core.NoMoreIDsException if a unique identifier could not be generated to
     *   be assigned
     */
    public synchronized static MySQLFeed getInstance(String inProviderName)
            throws NoMoreIDsException
    {
        if(sInstance != null) {
            return sInstance;
        }
        sInstance = new MySQLFeed(inProviderName);
        return sInstance;
    }
    /* (non-Javadoc)
    ...
    {
        return String.format("MySQLFeed"); //$NON-NLS-1$
    }
    /**
     * Create a new MySQLFeed instance.
     *
     * @param inProviderName a <code>String</code> value
     * @throws NoMoreIDsException if a unique identifier could not be generated to
     *   be assigned
     */
	private MySQLFeed(String inProviderName)
		throws NoMoreIDsException 
	{
	...
	public synchronized void start() {
        ...
        SLF4JLoggerProxy.debug(MySQLFeed.class,
                               "MySQLFeed starting"); //$NON-NLS-1$
    ...
    protected final synchronized void doCancel(String inHandle)
    {
        ...
        if(request == null) {
            CANCEL_REQUEST_FAILED_HANDLE_NOT_FOUND.warn(MySQLFeed.class,
                                                        inHandle);
            return;
        }
        request.stop();
     ...
     */
    @Override
    protected final boolean doLogin(MySQLFeedCredentials inCredentials)
    {
        setLoggedIn(true);
     ...
     */
    @Override
    protected final MySQLFeedToken generateToken(MarketDataFeedTokenSpec inTokenSpec)
            throws FeedException
    {
        return MySQLFeedToken.getToken(inTokenSpec,
                this);
    }
    /* (non-Javadoc)
     ...
     */
    @Override
    protected final MySQLFeedEventTranslator getEventTranslator()
    {
     ...
     */
    @Override
    protected final MySQLFeedMessageTranslator getMessageTranslator()
    {
        return MySQLFeedMessageTranslator.getInstance();
    }
    @Override
     ...
     */
    @Override
    protected void afterDoExecute(MySQLFeedToken inToken,
     ...
     */
    private MySQLFeedCredentials credentials;
    /**
    ...
    /**
     * capabilities for MySQLFeed - note that these are not dynamic as Bogus requires no provisioning
     */
    ...
    /**
     * static instance of <code>MySQLFeed</code>
     */
    private static MySQLFeed sInstance;
    /**
     * counter used to generate unique ids
     */
    private static final AtomicLong counter = new AtomicLong(0);
    /**
     * Corresponds to a single market data request submitted to {@link MySQLFeed}.
     *
     * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
     * @version $Id: MySQLFeed.java 16154 2012-07-14 16:34:05Z colin $
     * @since 1.5.0
